...
import { idlFactory } from './friends.did.js';
export { idlFactory } from './friends.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FRIENDS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./friends.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the friends canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./friends.did.js")._SERVICE>}
 */
export const friends = createActor(canisterId);
